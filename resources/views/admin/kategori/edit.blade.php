...
<div class="max-w-md bg-white rounded-xl shadow-sm p-6">
    <h2 class="text-lg font-bold text-[#3E4E3A] mb-5">Edit Kategori</h2>
    <form action="{{ route('admin.kategori.update', $kategori) }}" method="POST" class="space-y-4">
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="bg-[#E07A3F] hover:bg-orange-600 text-white font-semibold px-6 py-2.5 rounded-lg text-sm">Update</button>
